...
const dadosTabela = {
  ...
  body: [
    ['ÁLVARO JOSÉ BATISTA DA PAZ', 'alvaropaz015@outlook.com', '(82) 99108-4661', 'AL', 'Barra de Santo Antônio', '44503591783', 'Desfiliado', '<a href="/filiados/cadastro" class="btn btn-primary waves-effect"> <i class="fa fa-eye"></i></a>' ],
    ['WALLACE MAJOR DOS SANTOS', 'wlaylaelouyse@gmail.com', '(79) 3252-5308', 'BA', 'Coronel João Sá', '23455472100', 'Desfiliado', '<a href="/filiados/cadastro" class="btn btn-primary waves-effect"> <i class="fa fa-eye"></i></a>' ],
    ['JOAO PEDRO DE MOURA SOUZA', 'jpmssud@gmail.com', '(75) 99202-0319', 'BA', 'Feira de Santana', '146100180523', 'Regular', '<a href="/filiados/cadastro" class="btn btn-primary waves-effect"> <i class="fa fa-eye"></i></a>' ],
    ['ISAAC JEREMIAS JARDIM GOUVEA', 'gouveaisaac@hotmail.com', '(71) 99200-1754', 'BA', 'Salvador', '83222540558', 'Desfiliado', '<a href="/filiados/cadastro" class="btn btn-primary waves-effect"> <i class="fa fa-eye"></i></a>' ],
    ['JOSEFA SILVANA CARVALHO SILVESTRE', 'silvaninha_vidy@hotmail.com', '(11) 2015-7056', 'BA', 'Sítio do Quinto', '206043440191', 'Desfiliado', '<a href="/filiados/cadastro" class="btn btn-primary waves-effect"> <i class="fa fa-eye"></i></a>' ],
    ['PAULA SANTOS SAMPAIO SANTANA', 'psampaiosantana@gmail.com', '(11) 93020-5981', 'DF', 'Brasília', '22130502003', 'Regular', '<a href="/filiados/cadastro" class="btn btn-primary waves-effect"> <i class="fa fa-eye"></i></a>' ],
    ['DOMINGOS MACIEL DA SILVA LAMEGO', 'elianesilvaaalves@gmail.com', '(99) 98830-3649', 'MA', 'Aldeias Altas', '78029111120', 'Regular', '<a href="/filiados/cadastro" class="btn btn-primary waves-effect"> <i class="fa fa-eye"></i></a>' ],
    ['ITALO HENRIQUE RODRIGUES GOMES', 'italogomesadv@hotmail.com', '(99) 3621-3879', 'MA', 'Bacabal', '43125001104', 'Regular', '<a href="/filiados/cadastro" class="btn btn-primary waves-effect"> <i class="fa fa-eye"></i></a>' ],
    ['LUIS EDUARDO MOTA DOS SANTOS', 'luisedumota@yahoo.com', '(99) 3662-1064', 'MA', 'Dom Pedro', '73065931155', 'Desfiliado', '<a href="/filiados/cadastro" class="btn btn-primary waves-effect"> <i class="fa fa-eye"></i></a>' ],
    ['JOSÉ DA SILVA PEREIRA JUNIOR', 'juniorbatalia122@gmail.com', '(11) 4488-7087', 'MG', 'Piumhi', '40149851740', 'Regular', '<a href="/filiados/cadastro" class="btn btn-primary waves-effect"> <i class="fa fa-eye"></i></a>' ],
    ['WAGNER ALVES LACERDA JUNIOR', 'wagner.alacerda@yahoo.com.br', '(31) 3255-6198', 'MG', 'Sete Lagoas', '155900520281', 'Regular', '<a href="/filiados/cadastro" class="btn btn-primary waves-effect"> <i class="fa fa-eye"></i></a>' ],
    ['SANGELA RAMIRES DE SOUZA', 'ramiressangela945@gmail.com', '', 'MS', 'Jaraguari', '23940651945', 'Regular', '<a href="/filiados/cadastro" class="btn btn-primary waves-effect"> <i class="fa fa-eye"></i></a>' ],
    ['FRANCINE GNOATTO BASSO', 'frangbasso@gmail.com', '(67) 3295-3777', 'MS', 'São Gabriel do Oeste', '18809931961', 'Desfiliado', '<a href="/filiados/cadastro" class="btn btn-primary waves-effect"> <i class="fa fa-eye"></i></a>' ],
    ['HELENO SOUZA OCAMPO', 'heleno.ocampo@hotmail.com', '', 'MS', 'São Gabriel do Oeste', '17862111961', 'Desfiliado', '<a href="/filiados/cadastro" class="btn btn-primary waves-effect"> <i class="fa fa-eye"></i></a>' ],
    ['VILMA LEDA DE ALMEIDA SANTANNA', 'ledaemiliani07@gmail.com', '(67) 3295-1763', 'MS', 'São Gabriel do Oeste', '1085201945', 'Desfiliado', '<a href="/filiados/cadastro" class="btn btn-primary waves-effect"> <i class="fa fa-eye"></i></a>' ],
    ['WENDEL GOMES DE SOUZA LEÃO', 'WEN_WENDEL@HOTMAIL.COM', '(81) 99922-5777', 'PE', 'Recife', '77537320876', 'Regular', '<a href="/filiados/cadastro" class="btn btn-primary waves-effect"> <i class="fa fa-eye"></i></a>' ],
    ['MARCELO PEDRO DO NASCIMENTO', 'mpdn80@gmail.com', '(21) 2673-2817', 'RJ', 'Duque de Caxias', '112304740353', 'Regular', '<a href="/filiados/cadastro" class="btn btn-primary waves-effect"> <i class="fa fa-eye"></i></a>' ],
    ['LEONARDO DA SILVA ANVERSI', 'leonardo.anversi@gmail.com', '(21) 3870-1743', 'RJ', 'Rio de Janeiro', '40464800965', 'Desfiliado', '<a href="/filiados/cadastro" class="btn btn-primary waves-effect"> <i class="fa fa-eye"></i></a>' ],
    ['IVAN DO PRADO DE SOUZA', 'Carmo.prado@yahoo.com.br', '(12) 3107-1210', 'SP', 'Areias', '365065010132', 'Desfiliado', '<a href="/filiados/cadastro" class="btn btn-primary waves-effect"> <i class="fa fa-eye"></i></a>' ],
    ['CESAR DE AMORIM GONÇALVES', 'Cesar.goncalves3443@gmail.com', '', 'SP', 'Francisco Morato', '449127060116', 'Regular', '<a href="/filiados/cadastro" class="btn btn-primary waves-effect"> <i class="fa fa-eye"></i></a>' ],
    ['ALTAIR SANTOS IZIDORO JUNIOR', 'altairizidoro@hotmail.com', '', 'SP', 'Lins', '318498590167', 'Regular', '<a href="/filiados/cadastro" class="btn btn-primary waves-effect"> <i class="fa fa-eye"></i></a>' ],
    ['GUILHERME MANUEL PIRES DE CASTRO', 'guilherme_manuel@yahoo.com', '(17) 99643-7448', 'SP', 'Paranapuã', '453019250116', 'Regular', '<a href="/filiados/cadastro" class="btn btn-primary waves-effect"> <i class="fa fa-eye"></i></a>' ],
    ['RODRIGO ELTON SILVA DA CRUZ', 'rodrigocruzbgi@gmail.com', '(11) 98762-2168', 'SP', 'Penápolis', '311437330183', 'Regular', '<a href="/filiados/cadastro" class="btn btn-primary waves-effect"> <i class="fa fa-eye"></i></a>' ],
    ['HAILTON  OLIVEIRA', 'hailtoncaxias@gmail.com', '(16) 3636-9797', 'SP', 'Ribeirão Preto', '97476950310', 'Regular', '<a href="/filiados/cadastro" class="btn btn-primary waves-effect"> <i class="fa fa-eye"></i></a>' ],
    ['ALEXANDRE LUKAS MORRONE', 'alm089@hotmail.com', '(11) 5564-7273', 'SP', 'São Paulo', '359213510116', 'Regular', '<a href="/filiados/cadastro" class="btn btn-primary waves-effect"> <i class="fa fa-eye"></i></a>' ],
    ['DAYANE VIEIRA COSTA VIOLA', 'dayaneviola@hotmail.com', '(11) 99182-9179', 'SP', 'São Paulo', '92094970604', 'Regular', '<a href="/filiados/cadastro" class="btn btn-primary waves-effect"> <i class="fa fa-eye"></i></a>' ],
