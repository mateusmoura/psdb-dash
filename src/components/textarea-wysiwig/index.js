...
class TextareaWysiwig extends PureComponent {
  componentDidMount() {
    window.tinymce.init({
      selector: "textarea.textarea-wysiwig",
      theme: "modern",
      height: 300,
      plugins: [
  ...
  render() {
    return (
      <textarea className="textarea-wysiwig" name="area"></textarea>
    )
  }
}

export default TextareaWysiwig;
