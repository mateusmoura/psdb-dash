 ...
 */
! function(a, b) {
  "function" == typeof window.define && window.define ? window.define(["chartist"], function(c) {
      return a.returnExportsGlobal = b(c)
  }) : "object" == typeof exports ? module.exports = b(require("chartist")) : a["Chartist.plugins.tooltips"] = b(window.Chartist)
}(this, function(a) {
